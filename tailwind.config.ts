	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'fade-in-delay-100': 'fade-in 0.6s cubic-bezier(0.4, 0, 0.2, 1) 0.1s both',
				'fade-in-delay-200': 'fade-in 0.6s cubic-bezier(0.4, 0, 0.2, 1) 0.2s both',
				'fade-in-delay-300': 'fade-in 0.6s cubic-bezier(0.4, 0, 0.2, 1) 0.3s both',
				'fade-in-delay-400': 'fade-in 0.6s cubic-bezier(0.4, 0, 0.2, 1) 0.4s both'
			}
		}
	},
